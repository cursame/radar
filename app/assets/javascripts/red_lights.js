$(function() {
  $('.tabs').click(function(){
    ...
    $( "form#victima" ).submit(function( event ) {
	    var n = 0
	    $('.questions-list-1').find('input[type=checkbox]').each(function(i,e){
	       if($(e).is(':checked')){
	          n = n + 1
	       }
	    });
    ...
    $( "form#testigo" ).submit(function( event ) {
	    var n = 0
	    $('.questions-list-2').find('input[type=checkbox]').each(function(i,e){
	       if($(e).is(':checked')){
	          n = n + 1
	       }
	    });
